...
export function WhyWrongButton({ term, correctAnswer, userAnswer }: WhyWrongButtonProps) {
    ...
    return (
        <button
            id="why-wrong-btn"
            onClick={handleClick}
            className="flex items-center gap-2 text-sm text-zinc-400 hover:text-indigo-300 px-4 py-2 rounded-xl border border-zinc-700/50 hover:border-indigo-500/40 hover:bg-indigo-500/5 transition-all duration-200"
        >
