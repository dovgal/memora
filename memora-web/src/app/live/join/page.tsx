            ...
            <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-10">
                ...
                <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="text-center">
                        <h1 className="text-2xl font-extrabold text-white">Join Live Game</h1>
                ...
                <div className="flex gap-2 justify-center" onPaste={handlePaste}>
                    {code.map((digit, i) => (
                        <input
                            ...
                            className="w-12 h-14 text-center text-2xl font-black text-white bg-zinc-900 border-2 border-zinc-700 focus:border-emerald-500 rounded-xl outline-none transition-colors caret-emerald-400"
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-emerald-600 hover:bg-emerald-500 disabled:bg-zinc-800 disabled:text-zinc-600 disabled:cursor-not-allowed text-white font-bold py-4 rounded-2xl text-lg transition-all shadow-[0_0_30px_rgba(16,185,129,0.3)] hover:shadow-[0_0_40px_rgba(16,185,129,0.5)] hover:scale-[1.02] active:scale-[0.98]"
                >
                    {isJoining
