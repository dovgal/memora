...
const TEAM_COLOURS: Record<string, string> = {
    ...
    Panda: 'bg-zinc-200', Dragon: 'bg-red-500', Phoenix: 'bg-[#4255ff]',
};
                            ...
                            <div className="flex gap-4">
                                {answer ? (
                                    <button
                                        id="teacher-next-btn"
                                        onClick={sendNext}
                                        className="flex items-center gap-2 bg-[#4255ff] hover:bg-[#4255ff] text-white font-bold px-8 py-3 rounded-xl transition-all"
                                    >
