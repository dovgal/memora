                            ...
                            {podiumOrder.map((team, displayIdx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className={`text-sm font-bold ${actualRank === 0 ? 'text-yellow-400' : 'text-zinc-300'}`}>
                                            {team.team}
                                        </span>
                ...
                {missed.length > 0 && (
                    <section className="w-full max-w-lg">
                        <div className="flex items-center gap-2 mb-5">
                            ...
                            <h2 className="text-sm font-bold uppercase tracking-widest text-zinc-400">Top Missed Terms</h2>
                        </div>
