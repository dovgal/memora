        ...
        <div className="min-h-screen bg-qz-bg flex flex-col justify-center items-center relative overflow-hidden py-12">
            ...
            <div className="relative z-10 w-full max-w-md p-8 bg-qz-bg/60 backdrop-blur-xl border border-qz-border-light rounded-3xl shadow-2xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-qz-text-muted">Create an account to track progress.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-qz-text-muted mb-1">Confirm Password</label>
                        <input
                            type="password"
                            required
