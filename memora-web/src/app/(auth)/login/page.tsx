            ...
            <div className="relative z-10 w-full max-w-md p-8 bg-zinc-950/60 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-2xl">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full flex items-center justify-center space-x-3 bg-white hover:bg-zinc-200 text-black font-semibold py-3 px-4 rounded-xl transition-all duration-200 ease-out active:scale-[0.98]"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center space-x-3 bg-zinc-900 border border-zinc-700 hover:bg-zinc-800 hover:border-zinc-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 ease-out active:scale-[0.98]"
                    >
