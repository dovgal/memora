        ...
        <div className="min-h-screen bg-black flex flex-col justify-center items-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md p-8 bg-zinc-950/60 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-2xl">
                ...
                <button
                    ...
                    className="w-full mb-6 flex items-center justify-center space-x-3 bg-zinc-900 border border-zinc-700 hover:bg-zinc-800 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="text-center pt-4">
                        <p className="text-zinc-400 text-sm">
                            Don&apos;t have an account? <Link href="/register" className="text-white hover:text-purple-400 transition-colors font-medium">Register</Link>
                        </p>
                    </div>
                </form>
