        ...
        <div className="min-h-screen bg-qz-bg text-qz-text p-6 md:p-12 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    <div>
                        <h1 className="text-3xl font-semibold text-qz-text">Create a new study set</h1>
                        <p className="text-qz-text-muted mt-2">Add term and definition pairs to generate flashcards.</p>
                    </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    <section className="bg-qz-bg/60 backdrop-blur border border-qz-border-light p-6 sm:p-8 rounded-2xl flex flex-col gap-6">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            ...
                            />
                            <span className="text-qz-text-muted">Make this set visible to everyone</span>
                        </label>
                    </section>
