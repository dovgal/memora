...
// вдаль. Оно разрывает главное, от чего устают глаза, — непрерывную работу
// на одном близком расстоянии, поэтому таймер построен именно вокруг него.
        ...
        <div className="grid sm:grid-cols-2 gap-3 mb-7">
          {[
            ...
            { i: <Timer className="w-5 h-5 text-[#4255ff]" />, t: 'Сколько экрана в день',
              d: 'Разумный ориентир: до 5 лет — не более часа, 6–12 лет — около двух, подросткам — с перерывами каждые 20 минут. Уроки в этот счёт не входят, но перерывы нужны и в них.' },
          ].map((r, k) => (
