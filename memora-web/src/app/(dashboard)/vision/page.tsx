  ...
  return (
    <div className="min-h-screen bg-qz-card text-qz-text">
      <div className="max-w-4xl mx-auto px-4 py-6 md:py-8">
        ...
        {/* Родителям */}
        <section className="border-l-4 border-emerald-500 bg-emerald-500/5 rounded-xl p-5">
          <p className="font-bold text-foreground mb-2 flex items-center gap-2">
            <ShieldAlert className="w-4 h-4 text-emerald-500" /> Родителям
          </p>
          <ul className="space-y-2 text-sm text-qz-text-muted mb-4">
            <li>• <strong>Регулярность важнее длительности.</strong> Пять минут каждый день дают больше, чем час раз в неделю.</li>
            <li>• <strong>Занимайтесь вместе с ребёнком.</strong> Личный пример работает лучше любых уговоров, а взрослому гимнастика тоже не помешает.</li>
            <li>• <strong>Никакого насилия над глазами.</strong> Все упражнения — плавно, медленно, без волевых усилий и с обязательным морганием. Усилие сводит пользу на нет.</li>
            <li>• <strong>Больше дневного света.</strong> Час-два на улице каждый день — самая сильная поддержка для детских глаз, какая вообще есть.</li>
          </ul>

          <p className="text-sm font-bold text-red-500 mb-2">Когда гимнастику делать нельзя</p>
          <ul className="space-y-2 text-sm text-qz-text-muted mb-4">
            <li>• <strong>Отслоение сетчатки</strong> — гимнастика и массаж глаз запрещены категорически.</li>
            <li>• <strong>Менее 6 месяцев после любой операции на глазах</strong> — тоже запрещены.</li>
            <li>• <strong>Близорукость сильнее −4 диоптрий</strong> — только осторожно и не более 3–4 повторов: сетчатка натянута.</li>
            <li>• Появились <strong>головокружение, тошнота, боль</strong> — прекратить и сделать пальминг.</li>
            <li>• <strong>Никогда не смотреть на солнце открытыми глазами.</strong> Соляризация — только с закрытыми веками.</li>
          </ul>

          <p className="text-sm text-qz-text-muted">
            <strong>Про малышей.</strong> Примерно до 8–9 лет глаз ещё формируется. Если у ребёнка заметная
            разница между глазами, косоглазие или сильная дальнозоркость — это стоит показать специалисту:
            в таком возрасте подобное закрепляется необратимо, и упущенное время потом не вернуть.
            Гимнастике это не мешает — делайте её параллельно.
          </p>
        </section>
      </div>
    </div>
