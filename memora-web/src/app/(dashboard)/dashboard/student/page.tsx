    ...
    return (
        <div className="min-h-screen bg-qz-card text-qz-text selection:bg-[#4255ff]/30">
            <div className="p-8 max-w-7xl mx-auto space-y-16">
                ...
                {/* Разговор дня — первым: пять минут речи каждый день важнее выбора курса */}
                <DailyChallengeCard />
                        ...
                        <Link href="/coding/sql" className="block group">
                            <div className="relative h-full overflow-hidden rounded-3xl border border-[#262c40] bg-gradient-to-br from-sky-900/40 via-blue-900/20 to-transparent p-7 transition-all duration-300 hover:scale-[1.01] hover:border-sky-500/50">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-[#8e95ae] text-sm mb-4">11 дел-уроков: SELECT, WHERE, GROUP BY, JOIN, VIEW, оконные функции. Запросы выполняет Postgres в браузере.</p>
