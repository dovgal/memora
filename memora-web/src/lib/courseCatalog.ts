...
export const BUILTIN_COURSES: CatalogCourse[] = [
  ...
  // ---------- Английский язык ----------
  {
    ...
    description: 'Школьная таблица 3ème целиком: формы по инфинитиву, семейства с подсказкой цветом и перевод. Учитель задаёт партию — тренажёр сам возвращает слабые почаще.',
    subject: 'Английский язык', topic: 'Английский', level: '3ème', emoji: '🇬🇧',
  },
